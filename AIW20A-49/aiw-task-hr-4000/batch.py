...
program_path = 'C:/Users/user/Documents/aiwroot/aiw/AIW20A-49/aiw-task-hr-4000/application.py'
...
for filename in os.listdir(input_folder_path):
    ...
    if os.path.isfile(input_file_path):
        ...
        subprocess.run(['C:/Users/user/AppData/Local/Programs/Python/Python36/python.exe', program_path, 'flow', input_file_path, '900-600', '>=', '25'])
