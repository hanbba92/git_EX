...
class FileGenerateTest(unittest.TestCase):
    ...
    def test_file_generate(self):
        titles = ['tmp_925'] #사용할 데이터 목록

        ds = Dataset('/Users/user/Desktop/netcdf/aiw_task22_tmp_input_20220207.nc', 'w', format="NETCDF4") #새 nc파일 생성

        data = self.read('/Users/user/Desktop/gdaps/g128_v070_ergl_pres_h000.2022020700.nc') #등압면 데이터에서 가져올 예정
