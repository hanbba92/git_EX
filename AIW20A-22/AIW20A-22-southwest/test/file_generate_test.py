...
class FileGenerateTest(unittest.TestCase):
    ...
    def read(self, input_file):
        data = {
            'u_wind': self.read_task_values(input_file, '/UGRD_1000mb'), #1000hPa 기압면 데이터 사용 -> 925hPa CIN 아래
            'v_wind': self.read_task_values(input_file, '/VGRD_1000mb'),
    ...
    def test_file_generate(self):
        ...
        ds = Dataset('/Users/user/Desktop/netcdf/aiw_task22_southwest_input_20220207.nc', 'w', format="NETCDF4") #새 nc파일 생성
