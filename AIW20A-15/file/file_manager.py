...
class FileReader(object):
    ...
    def read(self, input_file):
        data = {
            'tmp_1D5maboveground': self.read_task_values(input_file, 'INPUTDATA/tmp_1D5maboveground/h000'),
            'rh_1D5maboveground': self.read_task_values(input_file, 'INPUTDATA/rh_1D5maboveground/h000'),
